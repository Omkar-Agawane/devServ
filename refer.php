...
<head>
    ...
    <meta property="og:description" content="create and check your domain name for your business name though teafweb platform" />
        ...
        <section class="container">
            <div class="flex2" id="mySignin">
                <div>
                    ...
                    <form id="mySignFormP2" name="signin" onsubmit="event.preventDefault();signinFormPrevent('mySignFormP2')" class="form1 gray-container">
                        <input id="myBusiness" type="text" name="businessname" class="input" placeholder="Reference Business Name*" required pattern="[a-zA-Z0-9@.]+" minlength="6" maxlength="20">
                        ...
                        <input id="myname" type="text" name="fname" class="input" placeholder="Reference Name*" required pattern="[a-zA-Z ]+" minlength="3" maxlength="20">
                        <input id="myphone" name="phone" type="text" class="input" placeholder="Reference Phone*" required pattern="[0-9]+" minlength="10" maxlength="12">
                        <input id="myemail" name="email" type="email" class="input" placeholder="Reference Email*" required minlength="6" maxlength="50">
