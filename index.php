...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WTHNN62" height="0" width="0"
    ...
    <main>
        <div class="slider">
            <section class="banner">
                <h3 class="h3 back-text">WEBSITES</h3>
                <div class="#">
                    <h1 class="h1 animate__animated animate__fadeInDown">Websites</h1>
                    <h2 class="h2 animate__animated animate__fadeInUp">Any kind of <span class="special">website</span>
                        informative,landing-page, portfolio etc</h2>
                </div>
                <div class="#">
                    <img class="animate__animated animate__fadeInDown" src="./res/website-banner.webp"
                        alt="comapany landing page website">
                </div>
            </section>
        </div>
        <div class="slider">
            <section class="banner">
                <h3 class="h3 back-text">Ecommerce</h3>
                <div class="#">
                    <h1 class="h1 animate__animated animate__fadeInDown">E-commerce</h1>
                    <h2 class=" h2 animate__animated animate__fadeInUp">A Easy and fast way to make
                        your buinsess <span class="special">online</span> </h2>
                </div>
                <div class="">
                    <img class="animate__animated animate__fadeInDown" src="./res/ecommerce.webp"
                        alt="ecommerce websites and business">
                </div>
            </section>
        </div>
        <div class="slider">
            <section class="banner">
                <h3 class="h3 back-text">Business <br>Tools</h3>
                <div class="#">
                ...
                <div class="">
                    <img class="animate__animated animate__fadeInDown" src="./res/business-tool.webp"
                        alt="business tools,hrm , leave manager">
                </div>
            </section>
        </div>
        ...
        <section class="">
            <div class="container-middle">
                <h4 class="h6 grayScale">Our Tech Stack </h4>
                <br>
                <br>
        ...
        <section class="dark-background">
            <div class="container ">
                <h6 class="h6">"Disruptive Thinking and Dynamic Design is in our Generation"</h6>
                <h5 class="h5">Teafweb is Your Best <span class="special">Digital</span> Partner, Believe it !
                </h5>
                <br><br><br>
                <br><br><br>
        ...
        <div class="container">
            <h5 class="h5 grayScale">How Teafweb Works?</h5>
            <hr class="hr">
        </div>
        <section class="flex-container">
            <div class="#">
                <img class="border1 img" src="./res/discover.webp" alt="discover the business problem">
            </div>
            <div class="text-box">
                <h5 class="h5 grayScale">Discover</h5>
                <hr class="hr">
                <p class="p grayScale">Your organization has a lot of needs in terms of the
                    digital sense. Discovering those problems and requisites is a
                    crucial thing and highlighting those is also an
                    important task. Teafweb expertise will pinpoint those features to
                    consider in designing your digital platform.</p>
            </div>
        </section>
        <section class="flex-container-dark">
            <div class="text-box">
                <h5 class="h5 ">Wire-Framing</h5>
                <hr class="hr">
                <p class="p ">Wireframing is the user flow of the
                    website/app. A super talented team
                    will generate a visual representation
                    of the website.</p>
            </div>
            <div class="#">
                <img class="border2 img" src="./res/wire-framing.webp" alt="discover the business problem">
            </div>
        </section>
        <section class="flex-container">
            <div class="#">
                <img class="border3 img" src="./res/build.webp" alt="discover the business problem">
            </div>
            <div class="text-box">
        ...
        <section class="flex-container-dark">
            ...
            <div class="text-box">
                ...
                <h5 class="h5">Scale</h5>

                <hr class="hr">

                <p class="p ">We will audit your website, analyse

                    key point

                    and highlight those pain

                    point and will bring solution.

                    We

                    check your digital presence and
            ...
            <div class="#">
                ...
                <img class="border4 img" src="./res/scale.webp" alt="discover the business problem">
